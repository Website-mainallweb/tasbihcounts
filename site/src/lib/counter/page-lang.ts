...
const EN = {
  streak: "Streak",
  streakEmpty: "Nothing recorded yet. Complete a round and the first day appears here.",
  current: "Current",
  best: "Best",
  ...
  days: "days",
  inAll: "in all",
  atRisk: "Today is still open. Finish a round to carry the streak forward.",
  ...
  noMala: "No round completed",

  statsTitle: "Dhikr Stats",
  timeTitle: "Time spent counting",
  ...
  monthly: "Monthly",
  yearly: "Yearly",
  statsEmpty: "Nothing recorded yet. Your counts appear here as you count.",
  earlier: "Earlier",
  later: "Later",
  filterByName: "Filter by dhikr",
  allNames: "All dhikr",
  beforeNames: "Before dhikr were tracked",
  total: "Total",
  perDay: "Average a day",
  unattributed:
    "Some days in this range were recorded before counts were kept per dhikr, so they are not included in this filter. “All dhikr” shows everything.",
